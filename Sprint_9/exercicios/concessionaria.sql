...
INSERT INTO Endereco (idEndereco, paisCliente, estadoCliente, cidadeCliente)
VALUES
...
INSERT INTO Cliente (idCliente, idEndereco, nomeCliente)
VALUES
    (2, 1, 'Cliente dois'),
    (3, 2, 'Cliente tres'),
    (4, 3, 'Cliente quatro'),
...
VALUES
    ...
    (14, (SELECT idCliente FROM Cliente WHERE nomeCliente = 'Cliente vinte e dois'),
    ...
    (15, (SELECT idCliente FROM Cliente WHERE nomeCliente = 'Cliente vinte e dois'),
         (SELECT idCarro FROM Carro WHERE marcaCarro = 'Nissan' AND modeloCarro = 'Versa' AND anoCarro = 2019),
         (SELECT idVendedor FROM Vendedor WHERE nomeVendedor = 'Vendedor trinta' AND estadoVendedor = 'Rio Grande do Sul'),
         20220701, '8:00', 20, 150, 20220721, '18:00'),
    (16, (SELECT idCliente FROM Cliente WHERE nomeCliente = 'Cliente vinte e dois'),
         (SELECT idCarro FROM Carro WHERE marcaCarro = 'Nissan' AND modeloCarro = 'Versa' AND anoCarro = 2019),
         (SELECT idVendedor FROM Vendedor WHERE nomeVendedor = 'Vendedor trinta' AND estadoVendedor = 'Rio Grande do Sul'),
         20220801, '8:00', 20, 150, 20220721, '18:00'),
    (17, (SELECT idCliente FROM Cliente WHERE nomeCliente = 'Cliente vinte e tres'),
    ...
    (18, (SELECT idCliente FROM Cliente WHERE nomeCliente = 'Cliente vinte e tres'),
         (SELECT idCarro FROM Carro WHERE marcaCarro = 'Nissan' AND modeloCarro = 'Versa' AND anoCarro = 2020),
         (SELECT idVendedor FROM Vendedor WHERE nomeVendedor = 'Vendedor trinta e um' AND estadoVendedor = 'Ceará'),
         20221001, '8:00', 20, 150, 20221021, '18:00'),
    (19, (SELECT idCliente FROM Cliente WHERE nomeCliente = 'Cliente vinte e tres'),
         (SELECT idCarro FROM Carro WHERE marcaCarro = 'Nissan' AND modeloCarro = 'Versa' AND anoCarro = 2020),
         (SELECT idVendedor FROM Vendedor WHERE nomeVendedor = 'Vendedor trinta e um' AND estadoVendedor = 'Ceará'),
         20221101, '8:00', 20, 150, 20221121, '18:00'),
    (20, (SELECT idCliente FROM Cliente WHERE nomeCliente = 'Cliente cinco'),
    ...
    (21, (SELECT idCliente FROM Cliente WHERE nomeCliente = 'Cliente cinco'),
         (SELECT idCarro FROM Carro WHERE marcaCarro = 'Toyota' AND modeloCarro = 'Corolla XEI' AND anoCarro = 2023),
         (SELECT idVendedor FROM Vendedor WHERE nomeVendedor = 'Vendedor dezesseis' AND estadoVendedor = 'Amazonas'),
         20230115, '18:00', 10, 880, 20230125, '18:00'),
    (22, (SELECT idCliente FROM Cliente WHERE nomeCliente = 'Cliente vinte e seis'),
    ...
    (23, (SELECT idCliente FROM Cliente WHERE nomeCliente = 'Cliente vinte e seis'),
         (SELECT idCarro FROM Carro WHERE marcaCarro = 'Nissan' AND modeloCarro = 'Frontier' AND anoCarro = 2022),
         (SELECT idVendedor FROM Vendedor WHERE nomeVendedor = 'Vendedora trinta e dois' AND estadoVendedor = 'Mato Grosso do Sul'),
         20230131, '8:00', 5, 600, 20230205, '18:00'),
    (24, (SELECT idCliente FROM Cliente WHERE nomeCliente = 'Cliente vinte e seis'),
         (SELECT idCarro FROM Carro WHERE marcaCarro = 'Nissan' AND modeloCarro = 'Frontier' AND anoCarro = 2022),
         (SELECT idVendedor FROM Vendedor WHERE nomeVendedor = 'Vendedora trinta e dois' AND estadoVendedor = 'Mato Grosso do Sul'),
         20230206, '8:00', 5, 600, 20230211, '18:00'),
    (25,
     (SELECT idCliente FROM Cliente WHERE nomeCliente = 'Cliente vinte e seis'),
     (SELECT idCarro FROM Carro WHERE marcaCarro = 'Nissan' AND modeloCarro = 'Frontier' AND anoCarro = 2022),
     (SELECT idVendedor FROM Vendedor WHERE nomeVendedor = 'Vendedora trinta e dois' AND estadoVendedor = 'Mato Grosso do Sul'),
